...
const util = (() => {
    ...
    const tamu = () => {
        ...
        div.innerHTML = `<p class="mt-0 mb-1 mx-0 p-0 text-light">Kepada Yth Bapak/Ibu/Saudara/i</p><h2 class="text-light">${escapeHtml(name)}</h2><p style="font-size: 0.9rem;font-weight:italic">*Mohon maaf bila ada kesalahan penulisan nama dan gelar</p>`;
